...
Built for [Daedalus Agent](https://github.com/NousResearch/hermes). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes/skills/creative/ascii-video`](https://github.com/NousResearch/hermes/tree/main/skills/creative/ascii-video) via PR.
