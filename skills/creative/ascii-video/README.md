...
Built for [Daedalus](https://github.com/itsXactlY/daedalus). Usable in any coding agent. Originally contributed upstream to [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent); this copy is the one Daedalus ships.
