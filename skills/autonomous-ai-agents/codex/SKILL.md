...
metadata:
  daedalus:
    ...
    related_skills: [claude-code, daedalus]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Daedalus terminal. Codex is OpenAI's autonomous coding agent CLI.
