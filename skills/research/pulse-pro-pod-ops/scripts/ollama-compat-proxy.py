...
The pulse-pro pod only speaks Ollama protocol (/api/tags, /api/generate).
llama.cpp speaks OpenAI-compat (/v1/chat/completions). This proxy
translates so the pod can use a local llama.cpp model without a rebuild.
