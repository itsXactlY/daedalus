...
DEFAULT_DATASETS = [
    ...
    "NousResearch/daedalus-megascience-sft1",
    "NousResearch/Daedalus-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Daedalus-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-daedalus"
]
