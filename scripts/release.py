...
AUTHOR_MAP = {
    ...
    "daedalus@nousresearch.com": "NousResearch",
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/daedalus",
...
def main():
    parser = argparse.ArgumentParser(description="Daedalus Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Daedalus Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        gh_cmd = [
            ...
            "--title", f"Daedalus Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Daedalus Agent v{new_version} ({calver_date})' "
