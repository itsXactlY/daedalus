"""ACP permission bridging — maps ACP approval requests to daedalus approval callbacks."""
...
def make_approval_callback(
    ...
    """
    Return a daedalus-compatible ``approval_callback(command, description) -> str``
