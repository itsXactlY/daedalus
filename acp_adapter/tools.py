"""ACP tool-call helpers for mapping daedalus tools to ACP ToolKind and building content."""
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a daedalus tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given daedalus tool invocation."""
