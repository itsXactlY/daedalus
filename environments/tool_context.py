...
ALL daedalus tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all daedalus tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any daedalus tool by name.
    ...
    def cleanup(self):
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("DAEDALUS_QUIET", None)
            else:
                os.environ["DAEDALUS_QUIET"] = _prev_quiet
