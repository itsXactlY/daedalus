"""
Monkey patches for making daedalus tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by daedalus_base_env.py).
