"""daedalus memory setup|status — configure memory provider plugins.
...
def _install_dependencies(provider_name: str) -> None:
    ...
    if not uv_path:
        ...
        print(f"  Then re-run: daedalus memory setup")
        return
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if not match:
        ...
        print("  Run 'daedalus memory setup' to see available providers.\n")
        return
...
def cmd_setup(args) -> None:
    ...
    if provider_config and hasattr(provider, "save_config"):
        try:
            provider.save_config(provider_config, daedalus_home)
        except Exception as e:
...
def cmd_status(args) -> None:
    ...
    if provider_name:
        ...
        if found:
            ...
            print(f"  Install the '{provider_name}' memory plugin to ~/.daedalus/plugins/")
