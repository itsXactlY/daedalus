...
def _update_via_zip(args):
    ...
    branch = "main"
    zip_url = f"https://github.com/NousResearch/daedalus/archive/refs/heads/{branch}.zip"
...
OFFICIAL_REPO_URLS = {
    ...
    "git@github.com:NousResearch/daedalus.git",
    "https://github.com/NousResearch/daedalus",
    "git@github.com:NousResearch/daedalus",
}
OFFICIAL_REPO_URL = "https://github.com/NousResearch/daedalus.git"
    ...
    if not has_upstream:
        ...
        if response in ("", "y", "yes"):
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print("  ✓ Added upstream: https://github.com/NousResearch/daedalus.git")
                has_upstream = True
            else:
                print("  ✗ Failed to add upstream remote. Skipping upstream sync.")
                return
        else:
            print("  Skipped. Run 'git remote add upstream https://github.com/NousResearch/daedalus.git' to add later.")
