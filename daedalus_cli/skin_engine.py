"""Daedalus CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.daedalus/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Daedalus Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Daedalus "       # Response box header label
...
.. code-block:: python
    ...
    from daedalus_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Daedalus Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.daedalus/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Daedalus gold/kawaii (the current look)
...
Drop a YAML file in ``~/.daedalus/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Daedalus — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Daedalus Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Daedalus ",
            "prompt_symbol": "❯ ",
...
def _skins_dir() -> Path:
    ...
    return get_daedalus_home() / "skins"
