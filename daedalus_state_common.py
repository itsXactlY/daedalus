...
Extracted verbatim from daedalus_state.py so the SessionDB mixin modules
(daedalus_state_search / daedalus_state_schema / daedalus_state_portability) can
reference them without importing daedalus_state (which would be a cycle).
daedalus_state re-imports every name here for backward compatibility.
"""
