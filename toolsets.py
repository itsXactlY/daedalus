...
TOOLSETS = {
    ...
    "daedalus-discord": {
        ...
        "tools": _DAEDALUS_CORE_TOOLS + ["discord", "discord_admin"],
        "includes": []
    },
    ...
    "daedalus-email": {
        "description": "Email bot toolset - interact with Daedalus via email (IMAP/SMTP)",
        "tools": _DAEDALUS_CORE_TOOLS,
        "includes": []
    },
    ...
    "daedalus-sms": {
        "description": "SMS bot toolset - interact with Daedalus via SMS (Twilio)",
        "tools": _DAEDALUS_CORE_TOOLS,
        "includes": []
    },
    ...
    "daedalus-gateway": {
        ...
        "tools": [],
        "includes": ["daedalus-telegram", "daedalus-discord", "daedalus-whatsapp", "daedalus-slack", "daedalus-signal", "daedalus-homeassistant", "daedalus-email", "daedalus-sms", "daedalus-mattermost", "daedalus-matrix", "daedalus-dingtalk", "daedalus-feishu", "daedalus-wecom", "daedalus-webhook"]
    }
}
