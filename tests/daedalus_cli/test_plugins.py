"""Tests for the Daedalus plugin system (daedalus_cli.plugins)."""
...
from daedalus_cli.plugins import (
    ENTRY_POINTS_GROUP,
    VALID_HOOKS,
    LoadedPlugin,
    PluginContext,
...
class TestPluginDiscovery:
    ...
    def test_discover_user_plugins(self, tmp_path, monkeypatch):
        """Plugins in ~/.daedalus/plugins/ are discovered."""
        plugins_dir = tmp_path / "daedalus_test" / "plugins"
    ...
    def test_discover_project_plugins(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("DAEDALUS_ENABLE_PROJECT_PLUGINS", "true")
        plugins_dir = project_dir / ".daedalus" / "plugins"
...
class TestPluginLoading:
    ...
    def test_load_registers_namespace_module(self, tmp_path, monkeypatch):
        """Directory plugins are importable under daedalus_plugins.<name>."""
        plugins_dir = tmp_path / "daedalus_test" / "plugins"
...
class TestPluginHooks:
    ...
    def test_invalid_hook_name_warns(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="daedalus_cli.plugins"):
            mgr = PluginManager()
            mgr.discover_and_load()
...
class TestPluginToolVisibility:
    ...
    def test_plugin_tools_in_definitions(self, tmp_path, monkeypatch):
        ...
        import daedalus_cli.plugins as plugins_mod
