...
class TestSetupProviderModelSelection:
    ...
    @patch("daedalus_cli.models.fetch_api_models", return_value=[])
    @patch("daedalus_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from daedalus_cli.setup import _setup_provider_model_selection
    ...
    @patch("daedalus_cli.models.fetch_api_models")
    @patch("daedalus_cli.config.get_env_value", return_value="fake-key")
    ...
    @patch("daedalus_cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"])
    @patch("daedalus_cli.config.get_env_value", return_value="fake-key")
