"""Tests for daedalus claw commands."""
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.daedalus/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.daedalus/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.daedalus/migration/openclaw/20250312T120000",
        }
