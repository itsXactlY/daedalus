"""Tests for `daedalus curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated DAEDALUS_HOME with real agent-created skills on disk."""
    ...
    from daedalus_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import daedalus_cli.curator as curator_cli
