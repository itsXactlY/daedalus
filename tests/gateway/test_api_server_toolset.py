"""Tests for daedalus-api-server toolset and API server tool availability."""
import os
import json
...
class TestDaedalusApiServerToolset:
    """Tests for the daedalus-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("daedalus-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("daedalus-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("daedalus-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "daedalus-api-server"
