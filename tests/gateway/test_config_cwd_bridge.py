...
class TestTopLevelCwdAlias:
    ...
    def test_top_level_cwd_sets_terminal_cwd(self):
        cfg = {"cwd": "/home/daedalus/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/daedalus/projects"

    def test_top_level_backend_sets_terminal_env(self):
        cfg = {"backend": "modal"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_ENV"] == "modal"

    def test_top_level_cwd_and_backend(self):
        cfg = {"backend": "local", "cwd": "/home/daedalus/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/daedalus/projects"
    ...
    def test_nested_terminal_takes_precedence_over_top_level(self):
        ...
        cfg = {
            "cwd": "/should/not/use",
            "terminal": {"cwd": "/home/daedalus/real"},
        }
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/daedalus/real"
    ...
    def test_no_cwd_falls_back_to_messaging_cwd(self):
        cfg = {}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/daedalus/projects"})
        assert result["TERMINAL_CWD"] == "/home/daedalus/projects"
