...
UDS socket lifecycle, daedalus_tools generation, timeout enforcement,
...
from tools.code_execution_tool import (
    ...
    execute_code,
    generate_daedalus_tools_module,
...
class TestDaedalusToolsGeneration(unittest.TestCase):
    ...
    def test_generates_subset(self):
        src = generate_daedalus_tools_module(["terminal", "web_search"])
    ...
    def test_rpc_infrastructure_present(self):
        src = generate_daedalus_tools_module(["terminal"])
        self.assertIn("DAEDALUS_RPC_SOCKET", src)
...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_repo_root_modules_are_importable(self):
        ...
        result = self._run('import daedalus_constants; print(daedalus_constants.__file__)')
        self.assertEqual(result["status"], "success")
        self.assertIn("daedalus_constants.py", result["output"])

    def test_single_tool_call(self):
        """Script calls terminal and prints the result."""
        code = """
from daedalus_tools import terminal
...
"""
    ...
    def test_multi_tool_chain(self):
        ...
        code = """
from daedalus_tools import terminal, read_file
r1 = terminal("ls")
...
"""
    ...
    def test_web_search_tool(self):
        ...
        code = """
from daedalus_tools import web_search
...
"""
    ...
    def test_json_parse_helper(self):
        ...
        code = r"""
from daedalus_tools import json_parse
...
"""
    ...
    def test_shell_quote_helper(self):
        ...
        code = """
from daedalus_tools import shell_quote
...
"""
    ...
    def test_retry_helper_success(self):
        ...
        code = """
from daedalus_tools import retry
counter = [0]
def flaky():
    counter[0] += 1
...
class TestStubSchemaDrift(unittest.TestCase):
    ...
    def test_generated_module_accepts_all_params(self):
        """The generated daedalus_tools.py module should accept all current params
...
class TestBuildExecuteCodeSchema(unittest.TestCase):
    ...
    def test_real_scenario_all_sandbox_tools_disabled(self):
        ...
        Scenario: user runs `daedalus tools code_execution` (only code_execution
    ...
    def test_real_scenario_only_vision_enabled(self):
        """Another real path: user runs `daedalus tools code_execution,vision`.
...
class TestEnvVarFiltering(unittest.TestCase):
    ...
    def test_daedalus_rpc_socket_injected(self):
        child_env = self._get_child_env()
        self.assertIn("DAEDALUS_RPC_SOCKET", child_env)
...
class TestExecuteCodeEdgeCases(unittest.TestCase):
    ...
    def test_none_enabled_tools_uses_all(self):
        ...
        code = (
            "from daedalus_tools import terminal, web_search, read_file\n"
    ...
    def test_empty_enabled_tools_uses_all(self):
        ...
        code = (
            "from daedalus_tools import terminal, web_search\n"
            "print('imports ok')\n"
        )
        with patch("model_tools.handle_function_call",
                    return_value=json.dumps({"ok": True})):
