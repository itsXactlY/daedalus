"""Tests for --yolo (DAEDALUS_YOLO_MODE) approval bypass."""
...
class TestYoloMode:
    """When DAEDALUS_YOLO_MODE is set, all dangerous commands are auto-approved."""
    ...
    def test_dangerous_command_blocked_normally(self, monkeypatch):
        ...
        monkeypatch.delenv("DAEDALUS_YOLO_MODE", raising=False)
    ...
    def test_dangerous_command_approved_in_yolo_mode(self, monkeypatch):
        """With DAEDALUS_YOLO_MODE, dangerous commands are auto-approved."""
        monkeypatch.setenv("DAEDALUS_YOLO_MODE", "1")
        monkeypatch.setenv("DAEDALUS_INTERACTIVE", "1")
        monkeypatch.setenv("DAEDALUS_SESSION_KEY", "test-session")
    ...
    def test_yolo_mode_empty_string_does_not_bypass(self, monkeypatch):
        ...
        monkeypatch.setenv("DAEDALUS_YOLO_MODE", "")
        monkeypatch.setenv("DAEDALUS_INTERACTIVE", "1")
        monkeypatch.setenv("DAEDALUS_SESSION_KEY", "test-session")
