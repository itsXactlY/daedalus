...
class TestCronjobRequirements:
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("DAEDALUS_GATEWAY_SESSION", "1")
        monkeypatch.delenv("DAEDALUS_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("DAEDALUS_INTERACTIVE", raising=False)
        monkeypatch.delenv("DAEDALUS_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("DAEDALUS_EXEC_ASK", "1")
...
class TestScheduleCronjob:
    ...
    def test_thread_id_captured_in_origin(self, monkeypatch):
        ...
        monkeypatch.setenv("DAEDALUS_SESSION_CHAT_ID", "123456")
        monkeypatch.setenv("DAEDALUS_SESSION_THREAD_ID", "42")
