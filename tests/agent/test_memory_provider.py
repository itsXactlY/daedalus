...
class TestPluginMemoryDiscovery:
    ...
    def test_discover_finds_mazemaker(self):
        """The mazemaker soak provider is the active external provider."""
...
class TestSetupFieldFiltering:
    ...
    memory setup wizard in daedalus_cli/memory_setup.py.
