"""Built-in boot-md hook — run ~/.daedalus/BOOT.md on gateway startup.

This hook is always registered. It silently skips if no BOOT.md exists.
To activate, create ``~/.daedalus/BOOT.md`` with instructions for the
...
BOOT_FILE = DAEDALUS_HOME / "BOOT.md"
