...
Hooks are discovered from ~/.daedalus/hooks/ directories, each containing:
...
HOOKS_DIR = get_daedalus_home() / "hooks"
    ...
    def _register_builtin_hooks(self) -> None:
        ...
        try:
            ...
            self._loaded_hooks.append({
                "name": "boot-md",
                "description": "Run ~/.daedalus/BOOT.md on gateway startup",
