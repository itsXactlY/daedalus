...
class GatewayConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        sessions_dir = get_daedalus_home() / "sessions"
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.daedalus/config.yaml (primary user-facing config)
    3. ~/.daedalus/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
