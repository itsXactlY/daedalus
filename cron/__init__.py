"""
Cron job scheduling system for Daedalus Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    daedalus gateway install    # Install as a user service
    sudo daedalus gateway install --system  # Linux servers: boot-time system service
    daedalus gateway            # Or run in foreground
