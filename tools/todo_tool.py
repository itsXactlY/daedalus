...
TODO_SCHEMA = {
    ...
    "description": (
        ...
        "(3+ steps) or multiple user tasks. Call with no params to read the list.\n\n"
        "Writing: provide 'todos' array. merge=false (default) replaces the whole "
        "list; merge=true updates items by id and adds new ones.\n\n"
        "Each item: {id, content, status: pending|in_progress|completed|cancelled}. "
        "Order = priority; only ONE in_progress at a time. Mark completed immediately; "
