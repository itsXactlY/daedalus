...
~/.daedalus/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.daedalus/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "memory for recurring tasks; new ones go to ~/.daedalus/skills/.\n\n"
        "Actions: create (full SKILL.md + category), "
        "patch (old_string/new_string — preferred for fixes), "
        "edit (full SKILL.md rewrite), delete, write_file, remove_file.\n\n"
        "Create after: complex task succeeded (5+ calls), errors overcome, "
        "user-corrected approach, reusable workflow. "
        "Update when: instructions stale/wrong, missing steps/pitfalls — patch immediately. "
        "Confirm with user before create/delete.\n\n"
        "Good skills: trigger conditions, numbered steps with exact commands, "
        "pitfalls, verification steps. See skill_view() for format examples."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "name": {
                ...
                "description": (
                    ...
                    "Must exist for patch/edit/delete/write_file/remove_file."
                )
            },
            "content": {
                "type": "string",
            ...
            "new_string": {
                "type": "string",
                "description": (
                    "Replacement text (required for 'patch'). Can be empty to delete."
                )
            },
            "replace_all": {
                "type": "boolean",
            ...
            "category": {
                "type": "string",
                "description": (
                    "Optional category subdirectory (e.g. 'devops'). "
            ...
            "file_path": {
                "type": "string",
                "description": (
                    "Supporting file in skill dir. write_file/remove_file: required, "
