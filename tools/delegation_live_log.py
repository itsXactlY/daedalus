...
per child under::
    ...
    <daedalus_home>/cache/delegation/live/<delegation_id>/task-<n>.log
...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.daedalus)."""
    from daedalus_constants import get_daedalus_dir

    return get_daedalus_dir("cache/delegation", "delegation_cache") / "live"
