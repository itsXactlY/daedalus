...
Only included in the daedalus-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Daedalus-Agent (https://github.com/NousResearch/daedalus)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_daedalus_home() / "cache" / "discord_capabilities.json"
