...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX at /tmp/daedalus-results/{tool_use_id}.txt via env.execute().
...
STORAGE_DIR = "/tmp/daedalus-results"
HEREDOC_MARKER = "DAEDALUS_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"DAEDALUS_PERSIST_{uuid.uuid4().hex[:8]}"
