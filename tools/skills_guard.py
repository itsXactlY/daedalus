...
Trust levels:
  - builtin:   Ships with Daedalus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.daedalus/\.env|\~/\.daedalus/\.env',
     "daedalus_env_access", "critical", "exfiltration",
     "directly references Daedalus secrets file"),
    ...
    (r'\.daedalus/config\.yaml|\.daedalus/SOUL\.md',
     "daedalus_config_mod", "critical", "persistence",
     "references Daedalus configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.daedalus/config.yaml."""
    try:
