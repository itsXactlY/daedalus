...
| `daedalus doctor start a3b` | the same, with the Qwen3.6-35B-A3B MoE instead of the dense 27B — same port, slots and context; `restart` keeps whichever is running unless you name one |
