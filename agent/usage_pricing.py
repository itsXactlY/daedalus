...
def normalize_usage(
    ...
    *,
    ...
    if mode == "anthropic_messages" or provider_name == "anthropic":
        primary_raw = getattr(response_usage, "input_tokens", None)
        input_tokens = _to_int(primary_raw)
        output_tokens = _to_int(getattr(response_usage, "output_tokens", 0))
        cache_read_tokens = _to_int(getattr(response_usage, "cache_read_input_tokens", 0))
        cache_write_tokens = _to_int(getattr(response_usage, "cache_creation_input_tokens", 0))
    elif mode == "codex_responses":
        primary_raw = getattr(response_usage, "input_tokens", None)
        input_total = _to_int(primary_raw)
        output_tokens = _to_int(getattr(response_usage, "output_tokens", 0))
        ...
        primary_raw = getattr(response_usage, "prompt_tokens", None)
        prompt_total = _to_int(primary_raw)
    ...
    return CanonicalUsage(
        ...
        prompt_field_missing=primary_raw is None,
    )
